"""
Django settings for our beltbadgers project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'beltbadgers/apps'))
    ...
    ROOT_URLCONF = 'beltbadgers.urls'

    WSGI_APPLICATION = 'beltbadgers.wsgi.application'
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "beltbadgers/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "beltbadgers/static"),
    )
